 ...
 * 待巡检详情
 */
public class TaskTodoDetailActivity extends BaseTaskDetailActivity implements View.OnClickListener {
    private static final String TAG = TaskTodoDetailActivity.class.getSimpleName();
